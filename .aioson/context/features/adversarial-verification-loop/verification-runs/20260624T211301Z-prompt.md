...
[
  ...
  {
    "type": "implementation_evidence",
    "role": "claim:CLAIM-016",
    "path": "src/verification/runners/index.js"
  },
  {
    "type": "implementation_evidence",
    "role": "claim:CLAIM-018",
...
[
  ...
  {
    "id": "GAP-002",
    "gap": "Runner mode is explicit only; Codex, Claude, and opencode are not auto-run by workflow and were not dogfooded against a paid/remote model in this slice.",
    "owner": "dev",
    "blocks": false
  },
  {
...
[
  ...
  },
  {
    ...
    "last_status": "passed",
    "run_by": "developer_or_clean_auditor",
    "expectation": "run when relevant to touched surface"
  },
  {
    "order": 13,
