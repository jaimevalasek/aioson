...
[
  {
    "id": "GAP-001",
    "gap": "Agent prompt trigger integration is deferred; agents do not yet automatically decide when to run verify:implementation.",
    "owner": "dev",
    "blocks": false
  },
  {
