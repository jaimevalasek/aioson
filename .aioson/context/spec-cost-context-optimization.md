...
phase_gates:
  ...
  plan: pending
  execution: pending
last_checkpoint: "Gate A approved by @analyst on 2026-06-01"
...
- Add scoped `agent:audit` modes.
- Add `skill:audit`.
- Add `context:health` drift warnings.
- Add focused tests for the remaining command surfaces.
