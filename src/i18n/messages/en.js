...
module.exports = {
  ...
  cli: {
    ...
    help_squad_eval:
      'aioson squad:eval [path] --squad=<slug> [--no-persist] [--json] [--locale=en]',
    help_squad_preflight:
      'aioson squad:preflight [path] --operation=<default-create|design|create|validate|eval|pilot|analyze|extend|repair|refresh|export|investigate|plan|configure-output|session-run> [--lane=quick|standard|premium|regulated] [--mode=content|software|research|mixed] [--signals=<a,b>] [--json] [--locale=en]',
