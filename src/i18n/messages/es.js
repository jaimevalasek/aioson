...
module.exports = {
  ...
  cli: {
    ...
    help_briefing_feedback:
      'aioson briefing:feedback [ruta] [--slug=<slug>] [--feedback=<ruta>] [--json] [--locale=es]',
    ...
    help_brain_query:
      'aioson brain:query [path] [--tags=<csv>] [--agent=<agente>] [--id=<csv>] [--min-quality=4] [--format=compact|index|json|ids] [--json] [--locale=es]',
    help_setup_context:
    ...
    help_squad_eval:
      'aioson squad:eval [ruta] --squad=<slug> [--no-persist] [--json] [--locale=es]',
    help_squad_preflight:
      'aioson squad:preflight [ruta] --operation=<operación> [--lane=quick|standard|premium|regulated] [--mode=content|software|research|mixed] [--signals=<a,b>] [--json] [--locale=es]',
    ...
    help_quality_run: "quality:run [path] --profile=<product|framework> [--dry-run] [--json] — Ejecuta verificaciones de calidad (product/framework; --dry-run muestra el plan)",
    help_quality_evals: "quality:evals [path] [--validate-seeds | --executor=<JSON argv>] [--compare=<run.json> --baseline=<run.json>] — Ejecuta evaluaciones o compara ejecuciones pareadas",
    help_quality_audit:
